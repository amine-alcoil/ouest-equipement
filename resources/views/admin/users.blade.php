                    ...
                    <tr class="border-t border-white/10">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                {{ $u->name }}
                                @if($u->role === 'admin')
<svg class="h-4 w-4 sm:h-4 sm:w-4 text-blue-500" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.25 16.517l-4.5-4.319 1.396-1.435 3.071 2.935 6.006-5.967 1.414 1.414-7.42 7.372z"/>
</svg>
