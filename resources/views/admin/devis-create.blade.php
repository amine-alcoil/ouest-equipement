        ...
        <form id="createDevisForm" class="space-y-6">
            ...
            <div id="specificFields" class="space-y-4 hidden">
                ...
                <div>
                    ...
                    <input type="number" name="budget" min="0" step="1000" class="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-white placeholder-white/50 focus:ring-2 focus:ring-secondary focus:border-transparent" placeholder="250000">
                </div>
            </div>
